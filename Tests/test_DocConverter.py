...
class TestSemicolonParser(unittest.TestCase):
    ...
    def test_func(self):
        ...
        self.assertEqual(r.access_modifier, AccessModifiers.PrivateProtected)
    ...
    def test_partial(self):
        ...
        r = SemicolonParser(PS.FileInfo('c'), strings, None).parse()
        self.assertEqual(type(r), PS.MethodInfo)
        self.assertEqual(r.access_modifier, AccessModifiers.Public)
    ...
    def test_abstract(self):
        ...
        r = SemicolonParser(PS.FileInfo('c'), strings, None).parse()
        self.assertEqual(type(r), PS.MethodInfo)
        self.assertEqual(r.access_modifier, AccessModifiers.Internal)
        self.assertEqual(
    ...
    def test_extern(self):
        ...
        r = SemicolonParser(PS.FileInfo('c'), strings, None).parse()
        self.assertEqual(type(r), PS.MethodInfo)
        self.assertEqual(r.access_modifier, AccessModifiers.ProtectedInternal)
    ...
    def test_virtual(self):
        ...
        r = SemicolonParser(PS.FileInfo('c'), strings, None).parse()
        self.assertEqual(type(r), PS.MethodInfo)
        self.assertEqual(r.access_modifier, AccessModifiers.Empty)
        self.assertEqual(r.args, [])
    ...
    def test_incorrect1(self):
        ...
        try:
            ...
            exc = e
        self.assertEqual(type(exc), NotAFieldException)
    ...
    def test_incorrect2(self):
        ...
        try:
            ...
            exc = e
        self.assertEqual(type(exc), WrongExpressionException)
...
class TestFunctions(unittest.TestCase):
    def test_quotes1(self):
        string = '\\"\\"third"'
        self.assertEqual(len(string), parse_quotes('"', string, 0))
    ...
    def test_quotes3(self):
        string = '\\\\\\"\\"third" + 1'
        self.assertEqual(len(string) - 4, parse_quotes('"', string, 0))

    def test_quotes_incorrect1(self):
        string = 'word, word'
        exc = None
        try:
            parse_quotes('"', string, 0)
        except ParseException as e:
            exc = e
        self.assertEqual(MissingQuoteException, type(exc))
    ...
    def test_parse_bracket(self):
        ...
        count = parse_brackets(opening, closing, char1, count)
        self.assertEqual(2, count)
        count = parse_brackets(opening, closing, char2, count)
        self.assertEqual(2, count)
        count = parse_brackets(opening, closing, char3, count)
        self.assertEqual(1, count)

    def test_is_operator(self):
        char = '+'
        self.assertEqual(True, is_operator(char))
        char = '~'
        self.assertEqual(True, is_operator(char))
        char = 'a'
        self.assertEqual(False, is_operator(char))
        char = 'operator'
        self.assertEqual(False, is_operator(char))
        char = '<<'
        self.assertEqual(True, is_operator(char))
    ...
    def test_is_field(self):
        ...
        self.assertEqual(True, is_field_checking(strings))
        strings = ['void a(string s = "=", string s1 = "{}=;")']
        self.assertEqual(False, is_field_checking(strings))
